...
def main():
    ...
    # ===== หน้ารับของเข้าสต็อก =====
        ...
        # ===== เลือกหมวดหมู่ก่อน (นอก form เพื่อให้ dynamic ได้) =====
        st.subheader("🏷️ เลือกหมวดหมู่สินค้า")
        ...
        selected_cat_display = st.selectbox("หมวดหมู่ *", list(cat_options.keys()), key="category_selector")
